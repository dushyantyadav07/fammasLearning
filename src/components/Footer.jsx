...
import course2 from "../assets/carousel-2.jpg"
import course3 from "../assets/carousel-1.jpg"
import course4 from "../assets/course-3.jpg"
import course5 from "../assets/cat-3.jpg"
            ...
            <div className="row g-5">
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <div className="row g-2 pt-2">
                        ...
                        <div className="col-4">
                             <img className="img-fluid bg-light p-1" src={course4} alt="" />
                        </div>
                        <div className="col-4">
                             <img className="img-fluid bg-light p-1" src={course5} alt="" />
                        </div>
                        <div className="col-4">
                             <img className="img-fluid bg-light p-1" src={course1} alt="" />
                        </div>
